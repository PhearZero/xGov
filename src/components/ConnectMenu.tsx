...
export default function ConnectMenu() {
    ...
    return (
        <div style={{position: "absolute", right: 0, padding: "var(--pico-block-spacing-vertical) 20px 0px 20px", borderRadius: 20,  backgroundColor: "var(--pico-secondary-border)"}}>
            {providers?.map((provider) => (
                <article key={provider.metadata.id}>
                    <h4>
                        <img
                            width={30}
                            height={30}
